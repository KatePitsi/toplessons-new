<div class="address text-zinc-700 text-left">
    ...
    <p class="text-sm py-2">
        <a href="<?php echo get_field('details_contact_details_address_url', 'option'); ?>" class="text-sm">
            ...
            <?php echo get_field('details_contact_details_address', 'option'); ?>
        </a>
    </p>
    <p class="text-sm py-2">
        <a href="tel:<?php echo get_field('details_contact_details_phone', 'option'); ?>" class="text-xs">
            ...
            <?php echo get_field('details_contact_details_phone', 'option'); ?>
        </a>
    </p>

    <p class="text-sm py-2">
        <a href="mailto:<?php echo get_field('details_contact_details_email', 'option'); ?>" class="text-sm">
            ...
            <?php echo get_field('details_contact_details_email', 'option'); ?>
        </a>
    </p>
