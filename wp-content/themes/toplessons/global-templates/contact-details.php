<div class="address text-zinc-700 text-left">
    ...
    <p class="text-xl font-bold mb-9">
        <?php esc_html_e( 'Στοιχεία επικοινωνίας' ); ?>
    </p>

    <p class="text-sm py-2">
        <a href="<?php echo get_field('contact_details_address_url', 'option'); ?>" class="text-sm">
            ...
            <?php echo get_field('contact_details_address', 'option'); ?>
        </a>
    </p>
    <p class="text-sm py-2">
        <a href="tel:<?php echo get_field('contact_details_phone', 'option'); ?>" class="text-xs">
            ...
            <?php echo get_field('contact_details_phone', 'option'); ?>
        </a>
    </p>
    <p class="text-sm py-2">
        <a href="tel:<?php echo get_field('contact_details_mobile', 'option'); ?>" class="text-xs">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-9 h-9 inline p-1.5 mr-2 border-solid border rounded-full border-black"><path stroke-linecap="round" stroke-linejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 006 3.75v16.5a2.25 2.25 0 002.25 2.25h7.5A2.25 2.25 0 0018 20.25V3.75a2.25 2.25 0 00-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3" /></svg>
            <?php echo get_field('contact_details_mobile', 'option'); ?>
        </a>
    </p>

    <p class="text-sm py-2">
        <a href="mailto:<?php echo get_field('contact_details_email', 'option'); ?>" class="text-sm">
            ...
            <?php echo get_field('contact_details_email', 'option'); ?>
        </a>
    </p>

    <p class="text-sm py-2">
        <a href="mailto:<?php echo get_field('contact_details_email_two', 'option'); ?>" class="text-sm">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-9 h-9 inline p-1.5 mr-2 border-solid border rounded-full border-black"><path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" /></svg>
            <?php echo get_field('contact_details_email_two', 'option'); ?>
        </a>
    </p>
